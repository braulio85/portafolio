...
function DataProvider({ children, settings }) {
    ...
    // _validateData debe estar antes de cualquier useEffect
    const _validateData = () => {
    ...
    }, [status, DataProviderStatus.STATUS_IDLE, DataProviderStatus.STATUS_PREPARING_FOR_LOADING]);

    useEffect(() => {
        if (status !== DataProviderStatus.STATUS_PREPARING_FOR_LOADING) return;
        setJsonData({});
        setStatus(DataProviderStatus.STATUS_LOADING);
    }, [status, DataProviderStatus.STATUS_PREPARING_FOR_LOADING, DataProviderStatus.STATUS_LOADING]);
    ...
    }, [status, DataProviderStatus.STATUS_LOADED, utils, _validateData]);
